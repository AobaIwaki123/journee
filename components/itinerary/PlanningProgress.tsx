...
export const PLANNING_PHASE_LABELS: Record<ItineraryPhase, string> = {
  initial: '準備中',
  collecting: '基本情報の収集',
  skeleton: '骨組みの作成',
  detailing: '日程の詳細化',
...
const PHASE_ORDER: ItineraryPhase[] = ['collecting', 'skeleton', 'detailing', 'completed'];

export const calculatePlanningProgress = (
  ...
  switch (planningPhase) {
    ...
    case 'detailing': {
      ...
      const totalDays =
        currentItinerary.duration || currentItinerary.schedule.length || 1;
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center space-x-2">
          ...
          <h3 className="text-sm font-semibold text-gray-700">
            {PLANNING_PHASE_LABELS[planningPhase as ItineraryPhase]}
          </h3>
        </div>
