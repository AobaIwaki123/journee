...
function handleMockResponse(stream: boolean) {
  const mockItinerary = {
    ...
    duration: 2,
    summary:
      "古都京都を満喫する2日間の旅程です。歴史的な寺社仏閣を巡り、京都の文化と美食を楽しみます。",
    schedule: [
      {
        day: 1,
        date: "2025-11-01",
        ...
        spots: [
          {
            ...
            name: "清水寺",
            description:
              "世界遺産に登録されている京都を代表する寺院。清水の舞台からの眺めは絶景です。",
            scheduledTime: "09:00",
            duration: 90,
          ...
          },
          {
            ...
            name: "二年坂・三年坂",
            description:
              "清水寺からの帰り道にある風情ある石畳の坂道。お土産屋さんが立ち並びます。",
            scheduledTime: "10:30",
            duration: 60,
            category: "sightseeing",
            estimatedCost: 0,
  ...
  const mockMessage =
    "テストモードです。京都2日間の旅程を作成しました！清水寺や金閣寺などの定番スポットを巡る充実したプランです。";
