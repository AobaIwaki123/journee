...
### Version 0.11.0 (閲覧モード マップリンク機能) ✅ 完了
**リリース日**: 2025-10-12

#### 新機能
- **住所マップリンク**: 閲覧モード・編集モードで住所をクリックしてGoogle Mapsを開く
- **AddressLinkコンポーネント**: 再利用可能な住所リンクコンポーネント
- **クロスプラットフォーム対応**: デスクトップ・モバイル両対応

#### 改善点
- SpotCard・EditableSpotCardで住所が自動的にリンク化
- 新しいタブでマップを開き、元のページを維持
- アクセシビリティ対応（適切なaria属性、title属性）

#### 主要ファイル
- `components/itinerary/AddressLink.tsx`
- `components/itinerary/SpotCard.tsx`
- `components/itinerary/EditableSpotCard.tsx`
- `components/itinerary/__tests__/AddressLink.test.tsx`
- `e2e/address-map-link.spec.ts`
